...
const PdfViewerModal = ({ show, onHide, documents }) => {
  const [currentIndex, setCurrentIndex] = useState(0);

  if (!documents || documents.length === 0) return null;

  const sanitizedDocs = Array.isArray(documents) ? documents : [documents];
  ...
  return (
    <Modal show={show} onHide={handleClose} size="xl" centered dialogClassName="d-flex justify-content-center align-items-center" backdrop="static" keyboard={false}>
